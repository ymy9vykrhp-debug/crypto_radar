      ...
      child: SingleChildScrollView(
        ...
        child: DataTable(
          ...
          columns: <DataColumn>[
            ...
            const DataColumn(label: Text('Avg R'), numeric: true),
            const DataColumn(label: Text('PF'), numeric: true),
            const DataColumn(label: Text('DD'), numeric: true),
              ...
              .map<DataRow>(
                (BacktestReport report) => DataRow(
                  ...
                  cells: <DataCell>[
                    ...
                    DataCell(Text(report.averageR.toStringAsFixed(2))),
                    DataCell(Text(report.profitFactor.toStringAsFixed(2))),
                    DataCell(
                      Text('${report.maxDrawdownR.toStringAsFixed(1)}R'),
                    ),
